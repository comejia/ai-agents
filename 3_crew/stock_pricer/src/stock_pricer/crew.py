...
class TrendingCompany(BaseModel):
    ...
    reason: str = Field(
        description="Razón por la que esta empresa está en tendencia en las noticias"
    )
...
class TrendingCompanyList(BaseModel):
    ...
    companies: List[TrendingCompany] = Field(
        description="Lista de empresas en tendencia en las noticias"
    )
...
class TrendingCompanyResearch(BaseModel):
    ...
    market_position: str = Field(
        description="Posición actual del mercado y análisis competitivo"
    )
    future_outlook: str = Field(
        description="Perspectiva futura y perspectivas de crecimiento"
    )
    investment_potential: str = Field(
        description="Potencial de inversión y adecuación para inversión"
    )
...
class TrendingCompanyResearchList(BaseModel):
    ...
    research_list: List[TrendingCompanyResearch] = Field(
        description="Investigación exhaustiva sobre todas las empresas en tendencia"
    )
